...
| [CRONOSTORIA.md](CRONOSTORIA.md) | Timeline Fase 0 → 2c → 3 |
...
| 11 | [11-cli.md](implementazioni/11-cli.md) | CLI (sync, predict, backtest, features, ablation) |
| 12 | [12-test-e-fixture-offline.md](implementazioni/12-test-e-fixture-offline.md) | 42 test, fixture 10 squadre |
...
[`.cursor/rules/sportmonks.mdc`](../../.cursor/rules/sportmonks.mdc)
